...
public enum SnakeDirection: Int {
    case up
    case right
    case down
    case left

    public var asInt2: int2 {
        switch self {
        case .up:
            return int2(x: 0, y: 1)
        case .right:
...
final public class SnakeSegmentNode: SCNNode {
...
final public class Snake: SCNNode {
    // MARK: - Properties
    public var direction: SnakeDirection = .down

    public var headPos: int2 {
        return body.first!
    }

    public var body: [int2] = [int2(0, 0), int2(0, 1), int2(0, 2)]
    public var lastBodySegment: int2?
    public var nodes: [SnakeSegmentNode] = []
